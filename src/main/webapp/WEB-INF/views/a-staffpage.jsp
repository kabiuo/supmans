...
<div class="unnav">
    <h3 style="margin-top: 22px;text-align: center;color: white;">商品信息管理</h3>
    <div class="row" style="height: 6%;">
        ...
        <div class="col-md-4" style="top: 3px;position: relative;">
            <a href="/staff/allinfo"><button type="button" class="btn btn-info">查询全部商品信息</button></a>
            <button type="button" class="btn btn-info" id="add-btn">新增商品信息</button>
        </div>
    </div>
    <div class="col-md-12">
        <table class="table">
            ...
            <c:forEach items="${pageInfo.list}" var="merch">
                <tr>
                    <td>${merch.merchid}</td>
                    <td>${merch.merchname}</td>
                    <td>${merch.merchaddress}</td>
                    <td>${merch.merchpd}</td>
                    <td>${merch.merchgp}</td>
